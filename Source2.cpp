...
int main() {
	...
	capture = cvCreateFileCapture("C:\\Users\\Balzrog\\Pictures\\Images DEFI H\\Mon film2.mp4"); // chemin pour un fichier
	...
	cvNamedWindow("Webcam Window", CV_WINDOW_AUTOSIZE);
	...
	while (key != 'q' && key != 'Q') {
		...
		printf("print");
		cvShowImage("Webcam Window", imagen);
...
//{
//	IplImage* imagen = cvLoadImage("C:\\Users\\Balzrog\\Pictures\\Images DEFI H\\voiture phare.jpg");
//	Mat image = cv::cvarrToMat(imagen, false);
